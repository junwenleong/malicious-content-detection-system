...
- **Model**: TF-IDF (20k features, 1-2 grams) + Logistic Regression (C=10)
- **Calibration**: Sigmoid method for reliable probability estimates
- **Threshold**: 0.536 (F1-optimized on validation set)

> **Note**: Demo dataset shows 98.82% ROC AUC. Production datasets typically show 85-92% AUC with more substantial calibration improvements.
